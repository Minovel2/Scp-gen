...
button.addEventListener("click", () => {
  h4.textContent = "Сейчас показываю: " + buttonTexts[btnCounter % 3];
  if (btnCounter % 3 == 2)
  input.placeholder = makeseed();

  btnCounter++;
  button.innerText = `Сгенерировать ${buttonTexts[btnCounter % 3]}`;
});
